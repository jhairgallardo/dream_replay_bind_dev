...
RUN_NAME=SeekOnly_frozenviewenc_mse${coeff_mse}_bce${coeff_bce}_ch${CHANNELS}_cosineLR_nohflip_cropzoom${zoom_min}_${zoom_max}_firstcenteranysize_bs${episode_batch_size}
